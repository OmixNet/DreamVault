...
// MockURLProtocol + MockURLProtocolHandler are now in
// `Tests/DreamEngineTests/MockURLProtocol.swift` (shared across tests in
// this target). v0.5 P2c-2 extraction: same harness serves both
// LLMSchemaTests (Ollama native) and OpenAICompatibleProviderTests.
